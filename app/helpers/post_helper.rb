module PostHelper
  ...
  def render_video(post)
    if post.video_url.present?
      "<iframe width='560' height='315' src='https://www.youtube.com/embed/#{self.video_id(post)}?autoplay=1&enablejsapi=1' frameborder='0' allowfullscreen></iframe>".html_safe
