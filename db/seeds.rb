...
spacetag8  = SpaceTag.create(polar: 44, azimuth: 46, radius: 211, relational_body: "Moon", units: "km", post: post8)
...
spacetag14 = SpaceTag.create(polar: 23, azimuth: 63, radius: 291, relational_body: "Moon", units: "km", post: post14)
spacetag15 = SpaceTag.create(polar: 63, azimuth: 21, radius: 0, relational_body: "Moon", units: "km", post: post15)
spacetag16 = SpaceTag.create(polar: 72, azimuth: 23.0, radius: 4.3, relational_body: "Solar Center", units: "Mkm", post: post16)
spacetag17 = SpaceTag.create(polar: 45, azimuth: 13, radius: 27, relational_body: "Propolarima Centurai", units: "LY", post: post17)
