...
user2  = User.create(name: "Frank Herbert", username: "frankherbert", email: "fronk@fronk.com", password: "password", password_confirmation: "password", confirmed: true)
...
post1  = Post.create(content: "Hello world! I'm posting from SPAAAAACE!", video_url: "https://www.youtube.com/watch?v=SGP6Y0Pnhe4", astronaut: astronaut2)
...
post3  = Post.create(content: "Ugh... gamma rays keep making my eyeballs light up. Not fun.", astronaut: astronaut1)
post4  = Post.create(content: "Whoa... what was that thing that zoomed by us just now? Didn't seem American... didn't even seem human. Odd.", astronaut: astronaut4)
...
post8  = Post.create(content: "So sick of freeze dried ice cream. FML.", astronaut: astronaut10)
...
post15 = Post.create(content: "On the moon!", image_url: "https://www.nasa.gov/sites/default/files/images/610213main_S73-22871_full.jpg", astronaut: astronaut12)
