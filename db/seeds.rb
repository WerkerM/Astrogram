...
user2 = User.create(name: "Frank", username: "frankiebaby", email: "fronk@fronk.com", password: "password", password_confirmation: "password")
user3 = User.create(name: "Steve", username: "steviebaby", email: "steev@steev.com", password: "password", password_confirmation: "password")
...
user7 = User.create(name: "Mikey 4EVA", username: "mikeymanbabycakes", email: "moik@mikey.com", password: "password", password_confirmation: "password")
user8 = User.create(name: "Snoozie the Snoozer", username: "snoozemaster", email: "snoozy@snooze.com", password: "password", password_confirmation: "password")
user9 = User.create(name: "Elizabeth Betsy Lee-Ann III", username: "lizzybaby", email: "elizabeth@lizzy.com", password: "password", password_confirmation: "password")
user10 = User.create(name: "George W. Bush", username: "bushbaby", email: "bushmaster@usa.gov", password: "password", password_confirmation: "password")
user11 = User.create(name: "Barack", username: "barackbaby", email: "elpresidente@gmail.com", password: "password", password_confirmation: "password")
user12 = User.create(name: "Larry David", username: "larrybaby", email: "larry@david.com", password: "password", password_confirmation: "password")
user13 = User.create(name: "Tom Waits", username: "waitingfortom", email: "tom@tomwaits.com", password: "password", password_confirmation: "password")
user14 = User.create(name: "Elizabeth Lemon", username: "lizzybaby", email: "lizisalemon@gmail.com", password: "password", password_confirmation: "password")
user15 = User.create(name: "Samantha Bee", username: "samanthababy", email: "sammy@bee.com", password: "password", password_confirmation: "password")
user16 = User.create(name: "Jessica Rabbit", username: "jessiebaby", email: "jessicarabbit@gmail.com", password: "password", password_confirmation: "password")
user17 = User.create(name: "Rachel McAdams", username: "rachel", email: "rachel@friends.com", password: "password", password_confirmation: "password")
...
astronaut3 = User.create(name: "Viktor M. Afanasyev", username: "afanofviktor", email: "viktor@tsniimash.ru", password: "password", password_confirmation: "password", astronaut: true)
astronaut4 = User.create(name: "Roberta Bondar", username: "robertabondar", email: "roberta@asc-csa.gc.ca", password: "password", password_confirmation: "password", astronaut: true)
astronaut5 = User.create(name: "Valentina Tereshkova", username: "valentina", email: "valentinatereshkova@tsniimash.ru", password: "password", password_confirmation: "password", astronaut: true)
astronaut6 = User.create(name: "Naoko Yamazaki", username: "naoko", email: "naoko@jaxa.jp", password: "password", password_confirmation: "password", astronaut: true)
astronaut7 = User.create(name: "Marcos Pontes", username: "marcospontes", email: "notrubio@inpe.br", password: "password", password_confirmation: "password", astronaut: true)
astronaut8 = User.create(name: "Klaus-Dietrich Flade", username: "klaus", email: "klaws@dlr.de", password: "password", password_confirmation: "password", astronaut: true)
astronaut9 = User.create(name: "James Adamson", username: "jamiethespacepilot", email: "goodsirjames@nasa.gov", password: "password", password_confirmation: "password", astronaut: true)
astronaut10 = User.create(name: "Jean-Loup Chrétien", username: "jeanloup", email: "jeanjean@cnes.fr", password: "password", password_confirmation: "password", astronaut: true)
astronaut11 = User.create(name: "Yang Liwei", username: "liweithefirst", email: "yangliwei@cnsa.gov.cn", password: "password", password_confirmation: "password", astronaut: true)
astronaut12 = User.create(name: "Reinhold Ewald", username: "reinontherhine", email: "reinhold@dlr.de", password: "password", password_confirmation: "password", astronaut: true)
astronaut13 = User.create(name: "Neil Armstrong", username: "neilarmy", email: "neila@nasa.gov", password: "password", password_confirmation: "password", astronaut: true)
astronaut14 = User.create(name: "Andreas Mogensen", username: "andreas", email: "andreas@esa.int", password: "password", password_confirmation: "password", astronaut: true)
astronaut15 = User.create(name: "Yuri Gagarin", username: "yurithegreatest", email: "yuri@tsniimash.ru", password: "password", password_confirmation: "password", astronaut: true)
astronaut16 = User.create(name: "Joseph M. Acaba", username: "joeymaca", email: "joey@nasa.gov", password: "password", password_confirmation: "password", astronaut: true)
astronaut17 = User.create(name: "Timothy Peake", username: "timpeake", email: "peektim@esa.int", password: "password", password_confirmation: "password", astronaut: true)
astronaut18 = User.create(name: "Samantha Cristoforetti", username: "samanthacris", email: "samantha@asi.it", password: "password", password_confirmation: "password", astronaut: true)
astronaut19 = User.create(name: "Jean-Loup Chrétien", username: "jeanloup", email: "jeanjean@cnes.fr", password: "password", password_confirmation: "password", astronaut: true)
astronaut20 = User.create(name: "Koichi Wakata", username: "koichi", email: "wakata@jaxa.jp", password: "password", password_confirmation: "password", astronaut: true)
astronaut21 = User.create(name: "Aydyn Aimbetov", username: "aydynaimbetov", email: "aydyn@tsniimash.ru", password: "password", password_confirmation: "password", astronaut: true)
astronaut22 = User.create(name: "Helen Sharman", username: "thegreathelena", email: "helena@stfc.ac.uk", password: "password", password_confirmation: "password", astronaut: true)
astronaut23 = User.create(name: "Buzz Aldrin", username: "buzzthegreatone", email: "buzz@nasa.gov", password: "password", password_confirmation: "password", astronaut: true)
astronaut24 = User.create(name: "Liu Yang", username: "yangliu", email: "yangliu@cnsa.gov.cn", password: "password", password_confirmation: "password", astronaut: true)
astronaut25 = User.create(name: "Michael Foale", username: "michaelfoale", email: "mikefoale@stfc.ac.uk", password: "password", password_confirmation: "password", astronaut: true)
astronaut26 = User.create(name: "Thomas Pesquet", username: "thomaspes", email: "thom@cnes.fr", password: "password", password_confirmation: "password", astronaut: true)
astronaut27 = User.create(name: "Mark Shuttleworth", username: "shuttleman", email: "mshuttle@stfc.ac.uk", password: "password", password_confirmation: "password", astronaut: true)
astronaut28 = User.create(name: "Chris Hadfield", username: "chrishadfield", email: "chris@asc-csa.gc.ca", password: "password", password_confirmation: "password", astronaut: true)
...
comment12 = Comment.create(content: "We miss you too. See you soon <3", post: post19, user: user20)
